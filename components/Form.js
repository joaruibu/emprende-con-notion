        ...
        <>
          <div className="p-6 mt-6 mb-6 bg-yellow-300 border border-stone-950 rounded-md items-center">
            ...
            <form
              ...
              method="post"
              data-id="191722FC90141D02184CB1B62AB3DC2666CEB8A31636BD4D3A71BB2DBA449EDE3FCCE6D48BABF849F8F4C6E50A91FD85E19A5610F60343109DECB5668DDE017E"
            >
              <div className="flex space-x-2 mb-2">
                <input
                  ...
                  placeholder="Introduce de email"
                  required="required"
                  type="email"
                  className="grow outline-none min-w-0  rounded-md border w-full bg-stone-50 hover:shadow-dark  transition-all border-stone-950 px-3.5 py-2 text-stone-950 sm:text-sm sm:leading-6 js-cm-email-input qa-input-email"
                ></input>
                <input
              ...
              <div className="flex items-center mb-2">
                ...
                >
                  ...
                  <a
                    ...
                    href="https://emprendeconnotion.com/privacidad/"
                    target="_blank"
                  >
              ...
              <p className=" text-[10px] leading-3 pb-0 text-gray-700">
                {" "}
                ...
                <a
                  className="underline text-gray-900"
                  href="https://emprendeconnotion.com/politica-de-privacidad/"
                  target="_blank"
                >
