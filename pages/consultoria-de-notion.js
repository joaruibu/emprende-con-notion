  ...
  return (
    <article className=" border-2 bg-stone-50 border-stone-950 p-4 rounded-xl my-8">
      ...
      <section className="pt-10 ">
        ...
        <p>
          Empleados corriendo de un lado a otro buscando productos, paquetes que
          se enviaban mal, clientes recibiendo cosas que no habían pedido. Como
          los almacenes estaban organizados por categorías, en cada esquina
        ...
        <br></br>
        <br></br>
        <p className="italic pl-6"> ¿La solución?</p>
        <br></br>
        <br></br>
        <p>
        ...
        <br></br>
        <br></br>
        <h2 className="font-alternate px-16 ">El Sistema Caótico de Amazon.</h2>
        <br></br>
        <br></br>
        <p>
          En lugar de organizar las cosas por categorías (como tú lo harías en
          tu cocina, con los vasos por un lado y los platos por otro), Amazon
          decidió mezclarlo todo.
        </p>
        <p>Como lo lees.</p>
        <p>
          ¿Un libro puede estar al lado de un paquete de pilas? Sí. ¿Un
          videojuego junto a una caja de pañales? También.{" "}
        </p>
        <p>
        ...
        <br></br>
        <br></br>
        <p className="italic pl-6"> Y ahora, el resultado.</p>
        <br></br>
        <br></br>
        <p>
          En cuestión de meses, los tiempos de envío se redujeron drásticamente.
          Las devoluciones por errores bajaron a mínimos históricos. Y Amazon
          llegó al estándar de velocidad y eficiencia que todos conocemos.
        </p>
        <p>
          Hoy, si pides algo y te llega al día siguiente, no es magia.{" "}
          <b> Es pura organización.</b>
        </p>
        <br></br>
        <br></br>
        <br></br>
        ...
        <p>
          <b>
            <span className="text-red-500">Dicho esto,</span> todo negocio o
            persona que sepa aplicar (BIEN) un sistema de organización, hará que
        ...
        <p>
          Y los trabajadores de oficinas aproximadamente{" "}
          <b>
            {" "}
            el 40% de su jornada laboral lo pierden en buscar información
            perdida, gestionar documentos mal clasificados, y lidiar con
        ...
        <div className="pb-12">
          <h2 className="text-2xl">
            ¿Utilizas algún método específico de productividad para generar los
            sistemas en Notion?
          </h2>
          <br></br>
          <p>
        ...
        <br></br>
        <div className="pb-12">
          <h2 className="text-2xl">¿Es para mí si…?</h2>
          <br></br>
          <ul className="pl-6">
            <li>
              <b> Quiero migrar información desde otra herramienta a Notion.</b>{" "}
              <br></br>
            ...
            <li>
              <b>
                He empezado a trabajar con Notion pero mi equipo no se
                acostumbra al nuevo sistema
              </b>{" "}
              <br></br>
              En esta situación, te puedo proponer una auditoría completa de tu
              sistema para identificar posibles fricciones y reconstruir todo el
              sistema de trabajo. También, puedo diseñar formaciones para tu
              equipo.
            </li>

            <li>
              <b> Utilizas demasiadas herramientas en tu empresa</b> <br></br>
              No solo por el ahorro de coste que puede conllevar. También para
              centralizar la información lo máximo posible.
            </li>

            <li>
              <b> Te gustaría conocer qué procesos se podrían automatizar</b>{" "}
              <br></br>
              Conectar Notion con otras herramientas es posible. Pero se debe
              analizar profundamente qué automatizaciones se pueden desarrollar,
              el costo de mantenimiento y toda una serie de cuestiones antes de
              tomar la decisión.
            </li>
            ...
            <li>
              <b>
                {" "}
                No tienes ni tiempo ni experiencia suficiente para dedicarle el
                tiempo que requiere crear un sistema Notion
              </b>{" "}
              <br></br>
              Para eso estamos.
            </li>
            <li>
              <b>
                {" "}
                Tienes un sistema en Notion, pero quieres ir un paso más allá y
                mejorar lo que ya has construido
              </b>{" "}
              <br></br>
              Quizás has tomado la decisión de implantar Notion en tu empresa o
              eres la encargada de hacerlo posible y necesitas acompañamiento en
              el proceso de estructurar tus bases de datos, crear plantillas e
        ...
        <div className="pb-12">
          <h2 className="text-2xl">
            Me preocupa la implementación, veo jodido acostumbrarme a Notion en
            el día a día, y para mi equipo más aún.
          </h2>
          <br></br>
          <p>
            Es que Notion no es fácil. ¿Te acuerdas de tu primer día de trabajo?
            Esa sensación de no saber dónde mirar información, con quién hablar,
            cómo encontrar tus tareas. <br></br> Esa misma sensación es la que
            se tiene cuando empiezas con una herramienta nueva como Notion, y es
            el motivo de la importancia de hacer un sistema adaptado a tu
            equipo, y también es el motivo de que incluya formación, tanto
            general de Notion como específica para vuestro nuevo sistema.
          </p>
        </div>
        <br></br>
        <div className="pb-12">
...
export default ConsultoriaDeNotion;
