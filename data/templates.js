...
const templates = [
  {
    ...
    template_summary: `
        ...
        `,
    template_body: `
        <p>De todas las plantillas que te regalo, esta de diario de agradecimiento + habit tracker es, sin duda, la que más ilusión me hace darte.</p>

        <br>

        <p>Estuve mucho tiempo dándole vueltas a si la vendía o la regalaba. </p>
        
        <p>Porque la plantilla aporta un valor tremendo. A mí personalmente me lo ha aportado. </p>
        
        <p>Y a los que formáis la comunidad de YouTube, también. Lo sé porque me lo habéis dicho en comentarios, puedes mirarlos si no me crees. </p>
        
        <p>La cuestión es que hice estudio de mercado y no sabía qué hacer. </p>
        
        <p>Otras personas que se dedican a esto de vender plantillas en Notion la venden. Precio alto. </p>
        ...
        <p>Segundo. Unos objetivos, sean cuales sean, sin seguimiento, no valen para nada.</p>
        
        <p>Y tercero. Ahora viene lo interesante.</p>
        
        <p>Tercero. Te cuento por qué combinar un Habit Tracker con un Diario de Agradecimiento aumenta exponencialmente su uso. Vamos allá.</p>
        <br>
        <p>En un estudio de gratitud realizado en la Universidad de California, a los participantes se les dividió al azar en tres grupos.</p>
        
        <p>Todos llevaban un diario semanal:</p>
        <ul class="list-disc list-inside">
        
        <li> El primer grupo describía las cosas por las que sentían agradecimiento.</li>
        <li> El segundo grupo explicaba todo aquello que les fastidiaba.</li>
        <li> El último hacía un seguimiento de los eventos neutrales.</li>
        
        </ul>

        <p>Al cabo de diez semanas, los participantes del primer grupo, el de gratitud, <b>rendían un promedio de 1,5 horas más</b> y se sentían un 25 por ciento más felices que los otros grupos.</p>
        
        <p>Es bestia el resultado, ¿eh?</p>
        <br>
        ...
        <br>
        <p>Y volviendo al principio y lo de si regalarla o cobrarla...</p>
  ...
  },
  {
    ...
    template_body: `
            ...
            <p>matarile, rile, rile.</p>
    
            <br>
    
            <p>Ahora en serio. </p>
            <p>¿Sabes dónde están tus llaves?</p>
    
            <p>O sea, ¿eres de las que no sabe dónde ha dejado las llaves? ¿O la cartera?</p>
    
            <br>
            <p>Joaquín es así. </p>
    
            <p>Joaquín es mi pareja, por cierto. </p>
  ...
  },
  {
    ...
    template_summary: `
            ...
            `,
    template_body: `
            <p>Un día hace poco me dejé las llaves en casa.</p>

            <p>Si no te ha pasado nunca, es raro. Pero igual sabes de oídas el dineral que cuesta llamar a un cerrajero.</p>
            
            <p>El caso.</p>
            
            <p>Hace unos años yo no solo me dejaba las llaves en casa.</p>
            
            <p>A veces se me olvidaba llamar a algún cliente. </p>
            
            <p>Me dejaba el móvil. </p>
            
            <p>Me dejaba las llaves. </p>
            
            <p>Me dejaba la cartera…</p>
            
            <p>Y las bragas. </p>
            
            <p>Sí, no es broma.</p>
            
            <p>Igual no te interesa por qué me dejé las bragas en casa. O igual sí, tú verás. </p>
  ...
  },
  {
    ...
    template_body: `
            ...
            <p>En un estudio universitario se quiso demostrar si las habilidades (como chutar un balón) pueden ser mejoradas por medio del pensamiento. </p>

            <p>O sea, de la imaginación.</p>

            <p>O sea, que tú te imaginas chutando un balón y entonces aprendes a chutarlo. </p>

            <p>Un poco loco, ¿no?</p>
    
            <br>

            <p>La cosa es que es que se puso a prueba el incremento de rendimiento en tiros libres acertados. O sea, pruebas de puntería. Pero en lugar de chutando un balón, lanzándolo.</p>
    ...
    form: {
      titleForm: "",
      textButton: "Suscribir y recibir plantilla.",
      label: "template-objetivosAñoNuevo",
      id: "fieldjkthbh",
      name: "cm-f-jkthbh",
    },
    imgs: [
  ...
  },
  {
    ...
    template_body: `
            ...
            <p>Hace varios años trabajé en una empresa.</p>

            <p>Una empresa grande. </p>

            <p>De esas con miles de empleados y que venden en más de 100 países. De esas que se llevan premios internacionales de sostenibilidad.</p>

            <p>Ese tipo de empresa en la que te sientes afortunado cuando te contratan, pero que el primer día ves que es más una secta que una empresa y vuelves a activar lo de buscar trabajo en LinkedIn.</p>
    
            <br>

            <p>Total que en esa empresa-secta lo primero y único que te regalaban al entrar era una agenda.</p> 

            <p>Pero no una agenda cualquiera. </p>

            <p>Era una agenda de papel con las tapas encuadernadas en polipiel de color verde corporativo y el logo grabado en letras doradas en el lomo. </p>

            <p>Eso sí, el ordenador que te asignaban era un portátil windows de hace 15 años con el teclado grasiento y que pesaba aún más que la agenda. Que ya es decir.</p>

            <br>
            
            <p>Por seguridad no nos dejaban digitalizar nuestras agendas-encuadernadas-en-polipiel-verde-corporativo-y-logo-grabado-en-letras-doradas ni en google. Sip, por seguridad. (Igual te piensas que la empresa daba claves nucleares peligrosas para la humanidad. Pero no. Era una empresa de cerámica, ¿sabes?).</p>

            <p>Total que yo con mi agenda-encuadernada-en-polipiel-verde-corporativo-y-logo-grabado-en-letras-doradas tenía que organizarme mis doscientas llamadas semanales, viajes, visita a las obras, reuniones internas… claro. Claro.</p>
    ...
    form: {
      titleForm: "",
      textButton: "Suscribir y recibir plantilla.",
      label: "template-planificadorSemanal",
      id: "fieldjkthbk",
      name: "cm-f-jkthbk",
    },
    imgs: [
  ...
  },
  {
    ...
    template_body: `
            ...
            <p>Me sacó una fotocopia en blanco y negro con casillas en las que escribir: </p>
            ...
            <p><b>Recibirás un email con el enlace a la plantilla y un vídeo explicándote paso a paso cómo funciona.</b></p>
            
            `,
    form: {
      titleForm: "",
      textButton: "Suscribir y recibir plantilla.",
      label: "template-fichajeHora",
      id: "fieldjkthbt",
      name: "cm-f-jkthbt",
    },
    imgs: [
  ...
  },
  {
    ...
    form: {
      titleForm: "",
      textButton: "Suscribir y recibir plantilla.",
      label: "template-contentCalendar",
      id: "fieldjkthby",
      name: "cm-f-jkthby",
    },
    imgs: [
  ...
  {
    title: "Plantilla para empezar en Notion",
    id: "11",
    isFree: true,
    template_summary: `
            <p>Si te sientes abrumado por empezar en Notion, te comparto de forma gratuita una plantilla para principiantes y su tutorial.</p>
            `,
    template_body: `
  
            <p> <b>Si te digo que busques dónde tienes tus contraseñas, o los apuntes del último curso que has hecho, o el listado de tareas de ayer…¿sabrías decirme dónde está? ¿y en cuántos sitios diferentes?</b></p>
            <br>
            <p>Quédate con esa pregunta, y déjame que te cuente una historia. </p>
            <br>
            <p>Cris es una tía súper curranta que mientras trabaja, a veces más de 8 horas al día, está estudiando y pagándose la carrera de psicología. </p>
            <p>Te haces una idea del perfil.</p>
            <p>Pues hace unas semanas quedamos cuatro amigas a cenar, entre ellas Cris.</p>
            <br>
            <p>Y mientras dábamos un paseo para bajar la hamburguesa, me empezaron a preguntar qué era eso de Notion porque no lo habían oído en su vida. </p>
            <p>Así que en lugar de explicárselo le pregunté a Cris que dónde se apunta ella sus contraseñas... Y me dijo que a veces en una libreta que tiene en el cajón del salón, y que otras veces en una nota del móvil. </p>
            <br>
            <p>¿Y los apuntes de la carrera? </p>
            <p><i>- A veces a mano. A veces en un word. A veces en un google doc. </i></p>
            <br>
            <p>¿Y dónde tiene las reflexiones del último libro de psicología que ha leído? </p>
            <p><i>- Subrayados en esos libros. O posits dentro de esos libros. </i></p>
            <br>
            <p>¿Y dónde están esos libros? </p>
            <p><i>- No sé. Quizás prestados, quizás en un cajón.</i></p>
            <br>
            <p>¿Y si necesita hacerse el típico listado de tareas en el trabajo? </p>
            <p><i>- Pues en una nota del móvil. Bueno, a veces también en un posit. O, lo mejor, directamente en su cabeza. </i></p>
            <br>
            <p>¿Y sus objetivos anuales de vida? </p>
            <p><i>Sí, esta pregunta fue a joder. Cuando estás empezando un proyecto o en su caso estudiando porque quiere cambiar su vida, tener objetivos claros es lo único que te da la energía de aguantar la mierda de tu trabajo actual. </i></p>
            <br>
            <p>La cosa es que en la mayoría de situaciones no tenía claro dónde coño se apuntaba las cosas. </p>
            <p>Y le expliqué que justo eso es Notion. Notion es paz mental. </p>
            <p><b>Notion es ese sitio donde puedes literalmente, vomitarlo todo. </b>Sin miedo de olvidarlo o de no encontrarlo. Siempre vas a tener ahí tu información categorizada.</p>
            <br>
            <p>Pero empezar, ya debes de saber que a veces puede ser abrumador</p>
            <p>¿Por qué? Pues porque es totalmente personalizable. Y coño, si estamos empezando, es normal que no tengamos claro qué necesitamos, y qué no. </p>
            <br>
            <p>Para es es esta plantilla. </p>
            <p>Es una plantilla para principiantes, pensada para crecer contigo conforme tú vayas aprendiendo más cosas de Notion y organizándote. </p>
            <br>
            <p><b>Para suscribirte y recibir la plantilla, abajo.</b></p>
            <p><b>Recibirás un email con el enlace a la plantilla y un vídeo explicándote paso a paso cómo funciona.</b></p>
            `,
    form: {
      titleForm: "",
      textButton: "Suscribir y recibir plantilla.",
      label: "template-empezarNotion",
      id: "fieldtldkuud",
      name: "cm-f-tldkuud",
    },
    imgs: [
      "https://res.cloudinary.com/dwsa2s0pn/image/upload/v1732301910/emprende-con-notion/template/Empezar%20en%20Notion/Plantilla_para_empezar_en_Notion_-_emprende_con_notion_hggkei.webp",
      "https://res.cloudinary.com/dwsa2s0pn/image/upload/v1732301911/emprende-con-notion/template/Empezar%20en%20Notion/Plantilla_para_empezar_en_Notion_-_emprende_con_notion1_sv4hyd.webp",
      "https://res.cloudinary.com/dwsa2s0pn/image/upload/v1732301912/emprende-con-notion/template/Empezar%20en%20Notion/Plantilla_para_empezar_en_Notion_-_emprende_con_notion2_jmp2eq.webp",
    ],
    tags: [TAG_TEMPLATES_TYPE.personal],
  },
